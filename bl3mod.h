 ...
 * objClass: mesh group object, object that has pointers to meshes you can place
 * obj: object to place on map
 * to_val: "to value" (see mesh_coord(...) for a quick way to make this value)
 * visible: visible or not NOTE: THIS VALUE IS INVERTED; 0 IS VISIBLE AND 1 IS INVISIBLE
 */
